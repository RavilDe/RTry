...
fun1 <- function(path) {
# path <- "/Users/macmini/Desktop/OES_output/СЧЕТ-ФАКТУРА №  от 30 апреля 2016 г._715.xlsx"
 ...
 df_out <- data_frame("Счет-фактура" = c(df$X__1[2]),
                      ...
                      "Всего к оплате" = c(df$X__13[bingo_row]), # для дв ИСПРавит для СЗ
...
fun2 <- function(path) {
# path <- "/Users/macmini/Desktop/OES_output/Акт приема-передачи электрической энергии № Э-989-06-7 от 31 декабря 2015 г. исправление №1 от 31 мая 2016 г._1658.xlsx"
...
```{r}
fun3 <- function(path) {
  # path <- "~/Desktop/OES_output/КОРРЕКТИРОВОЧНЫЙ СЧЕТ-ФАКТУРА № К-112-06-42 от 31 мая 2016 г. ИСПРАВЛЕНИЕ КОРРЕКТИРОВОЧНОГО СЧЕТА-ФАКТУРЫ № ---  от  ---_7.xlsx"
...
```{r}
fun5 <- function(path) {
 path <- "~/Desktop/OES_output/Корректировочный акт приема-передачи электрической энергии № К-203-06-49 от 31 мая 2016 г. к акту приема-передачи электрической энергии № К-682-06-49 от 30 ноября 2015 г. с учетом исправления № 2 от 31 января 2016 г._1739.xlsx"
