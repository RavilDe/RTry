...
```
Более подробное описание всех настроек и параметров этого файла можно найти  в [Appendix](http://docs.rstudio.com/shiny-server/#appendix)'e Shiny Administrator’s Guide.
