...
### 2.4.4 Изменение параметров шкалы (легенды) переменной отвечающей за цвет, заливку, размер и вид точки на графике
...
* **это инструмент длдя встраивания результатов исполнения кода на `R` в текст документа**; большое количество форматов, причем постоянно растущее
