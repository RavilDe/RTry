...
# При сборке .Rmd файла разметка markdown заменяется HTML тэгами
# но тэги можно использовать напрямую
# <u>Подчеркнутый текст</u> 
   
## CSS
# CSS - это способ изменять стили отображенияэлементов, не меняя текст
# markdown-файла
# Это некий дополнительный уровень абстракции над HTML: разметка отдельно, 
# стили отдельно (в YAML)
...
# Или принудительнопр помощи строки из дефисов:
# --- (четыре должно быть)
# у каждого формата свои удобства показа, визульного оформленияб конфигурации..

   
## ggvis
# HTML хорош тем, что может быть интерактивным за счет javascript
